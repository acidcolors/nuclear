    ...
    return (
        <>
            ...
            >
                ...
                <div className="flex items-center justify-between px-[100px] pt-[10px] pb-1 min-h-[60px]">
                    {orderStatus !== 'success' && (
                        <>
                            ...
                            <button
                                onClick={() => setIsOpen(false)}
                                className="p-1 hover:opacity-60 transition-opacity border-none outline-none bg-transparent cursor-pointer"
                            >
                ...
                {/* Content */}
                <div className="flex-1 overflow-y-auto custom-scrollbar px-[100px] pt-0 pb-12">
                    {orderStatus === 'success' ? (
                        <div
                            ref={successRef}
